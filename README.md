...
# --- Tables ---
# Martian (unroutable) addresses - IPv4
table <martians> {
...
# Martian (unroutable) addresses - IPv6
table <martians6> {
...
* `pass in ... inet proto icmp`: Allows essential IPv4 diagnostic traffic like Ping (`echoreq`) and "Unreachable" notices.
